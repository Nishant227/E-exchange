<html>
<head>
	<body background="image/backg.jpg">
		<br>

		<center><h1 style="color: white;">
                       Welcome To E-exchange
                    </h1>

                <img src="image/logo1.jpg"  width="100" height="50" style="background-color:yellow"></center>
                </head>
<style>
		img {
  border-radius:0px;
...
<button  onclick="document.location='http://localhost/php/E_exchange/signup.php'"class="button button2" >Sign Up</button>
</html>
