...
<div class="row">
   <div class="column">
      <center> <a href=""><img src="image/electronics/ac1.jpg"  width="200" height="180" onclick>
     ...
     <div class="column">
      <center> <a href=""><img src="image/electronics/cooler1.jpg"  width="200" height="180">
             <h5>  <center>HP</a><h2>₹6900 <h4>2010 </h4><h3> With Bill</h3></h2> </h5>
          <h3> <button onclick="document.location='cart.php'">ADD TO CART</button>
           <button onclick="document.location='buy.php'">BUY NOW</button></h3></center>
    </div>         
   <div class="column">
    <center> <a href=""> <img src="image/electronics/ps1.jpg"  width="200" height="180">
            <h5><center>HP</a><h2>₹20500 <h4>2015 </h4><h3>With Bill</h3></h2> </h5>
          <h3> <button onclick="document.location='cart.php'">ADD TO CART</button>
           <button onclick="document.location='buy.php'">BUY NOW</button></h3></center>
    </div>        
    <div class="column">        
      <center> <a href=""> <img src="image/electronics/trimmer1.jpg"  width="200" height="180">
                <h5><center>Acer</a><h2>₹14900 <h4>2015 </h4><h3>With Bill</h3></h2> </h5>
          <h3> <button onclick="document.location='cart.php'">ADD TO CART</button>
           <button onclick="document.location='buy.php'">BUY NOW</button></h3></center>
    </div>
    <div class="column">            
      <center><a href=""> <img src="image/electronics/tv1.jpg"   width="200" height="180">
             <h5><center>Dell</a><h2>₹15199 <h4>2016 </h4><h3>With Bill</h3></h2> </h5>
          <h3> <button onclick="document.location='cart.php'">ADD TO CART</button>
           <button onclick="document.location='buy.php'">BUY NOW</button></h3></center>
    </div>
    <div class="column">            
      <center> <a href=""> <img src="image/electronics/wm1.jpg"  width="200" height="180">
            <h5><center>HP</a><h2>₹15490 <h4>2015 </h4><h3>With Bill</h3></h2> </h5>
          <h3> <button onclick="document.location='cart.php'">ADD TO CART</button>
           <button onclick="document.location='buy.php'">BUY NOW</button></h3></center>
    </div>
    <div class="column">            
      <center> <a href=""> <img src="image/electronics/fan1.jpg"  width="200" height="180">
            <h5><center>Lenovo</a><h2>₹12970 <h4>2013 </h4><h3>With Bill</h3></h2> </h5>
          <h3> <button onclick="document.location='cart.php'">ADD TO CART</button>
           <button onclick="document.location='buy.php'">BUY NOW</button></h3></center>
    </div>
    <div class="column">            
      <center> <a href=""> <img src="image/electronics/fridge1.jpg"  width="200" height="180">
